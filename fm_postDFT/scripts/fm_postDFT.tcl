...
read_verilog -container Imp "../DFT/outputs/${design_name}.v"
set_implementation_design $design_name
set_top $design_name

##Dont Verify dft
set_dont_verify_points -type port Ref:/WORK/SystemTop/SI
set_dont_verify_points -type port Ref:/WORK/SystemTop/SO

set_dont_verify_points -type port Imp:/WORK/SystemTop/SI
set_dont_verify_points -type port Imp:/WORK/SystemTop/SO

##DFT constants
set_constant Ref:/WORK/SystemTop/TEST_MODE 0
set_constant Imp:/WORK/SystemTop/TEST_MODE 0

set_constant Ref:/WORK/SystemTop/SCAN_EN 0
set_constant Imp:/WORK/SystemTop/SCAN_EN 0 
## Match
match
